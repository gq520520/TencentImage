            ...
            if (isset($args['path'])) {
                ...
                switch (count($parts)) {
                    case 6:
                        ...
                        $bucket = $parts[4];
                        $userid = $parts[5];
                        return array('cate' => $cate, 'ver' => $ver, 'appid' => $appid, 'bucket' => $bucket,
                                     'userid' => $userid);
                        break;
                    case 7:
                        $cate = $parts[1];
                    ...
                    case 8:
                        ...
                        $oper = $parts[7];
                        return array('cate' => $cate, 'ver' => $ver, 'appid' => $appid, 'bucket' => $bucket,
                                     'userid' => $userid, 'fileid' => $fileid, 'oper' => $oper);
                        break;
                    default:
                        return array();
                }
            ...
            if (isset($args['path'])) {
                ...
                switch (count($parts)) {
                    case 5:
                        ...
                        $fileid = $parts[3];
                        $style = $parts[4];
                        return array('appid' => $appid, 'bucket' => $bucket, 'userid' => $userid, 'fileid' => $fileid,
                                     'style' => $style);
                        break;
                    default:
                        return array();
