...
namespace App\Utils\TencentImage;
...
class Conf {
    ...
    const API_PRONDETECT_URL = 'http://service.image.myqcloud.com/v1/detection/porn_detect';
    // 以下部分请您根据在qcloud申请到的项目id和对应的secret id和secret key进行修改

    const APPID = 10002987;
    const SECRET_ID = 'AKIDU6I6YsHkEjn4yIuddysRSuuOpYEmmsRV';
    const SECRET_KEY = 'egLZKRfRr6AUzByUdGNlErMCZ8SZJKCu';
    const BUCKET = 'passport';
